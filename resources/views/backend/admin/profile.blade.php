                          ...
                          <div class="form-group">
                            ...
                            <div id="imagePreviewContainer">
                                @if(Auth::user()->profile_image)
                                    <img src="{{ asset('backend/photos/' . Auth::user()->profile_image) }}" alt="Default Profile Image" class="img-thumbnail" id="previewImage" style="max-width: 150px; max-height: 150px;">
                                @endif
                            </div> 
                        </div>
